...
public class DeleteProductFormHandler implements HttpHandler{
...
// and the number of BYTES (not utf-8 characters) from the body is: buf.length()
        ...
        try {
            // verify user
            boolean updateProductSuccess = productDAO.deleteProduct(id); // add to database
            String outputMessage = updateProductSuccess ? "Product deleted" : "Error: Please try again";
