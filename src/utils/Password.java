...
public class Password {
    // Define the Util.BCrypt workload to use when generating password hashes. 10-31 is a valid value.
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Testing Util.BCrypt Util.Password hashing and verification");
